          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <a href="https://frozen-reaches-00850.herokuapp.com/prove/prove03/browse_items.php" class="btn btn-primary btn-lg" role="button" aria-disabled="true" target="_blank">Shopping Cart</a>
                <br>
                <br>
                <a href="https://frozen-reaches-00850.herokuapp.com/prove/prove05/prove05.php" class="btn btn-primary btn-lg" role="button" aria-disabled="true" target="_blank">Fighting Simulator</a>
